 ...
 def onTalk (self,npc,player):
   ...
   if npcId == 30473 :
     ...
     if st.getInt("cond")==6 and st.getQuestItemsCount(ORDER_OF_SORIUS) :
      ...
      #st.addSpawn(27122,-97547,106503,-3405) double code...
      #st.addSpawn(27122,-97526,106584,-3405) double code...
      #st.addSpawn(27123,-97441,106585,-3405) double code...
     ...
     if st.getInt("cond")==8 :
      ...
      st.addSpawn(27124, player, True, 0)
      st.addSpawn(27124, player, True, 0)
      st.addSpawn(27124, player, True, 0)
      st.playSound("Itemsound.quest_before_battle")
      st.set("cond","9")
      ...
      st.addSpawn(27125, player, True, 0)
      st.addSpawn(27125, player, True, 0)
      st.addSpawn(27125, player, True, 0)
      st.playSound("Itemsound.quest_before_battle")
      st.set("cond","11")
      ...
      st.addSpawn(27126, player, True, 0)
      st.addSpawn(27126, player, True, 0)
      st.addSpawn(27127, player, True, 0)
      st.playSound("Itemsound.quest_before_battle")
      st.set("cond","13")
     elif st.getInt("cond") == 13 :
