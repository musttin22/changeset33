...
ARKS={
HOLY_ARK_OF_SECRECY_1: [FIRST_KEY_OF_ARK,0,"30977-01.htm","30977-02.htm","30977-03.htm",BLOOD_OF_SAINT,"harne","You forgot to visit Harne! ;)"],
HOLY_ARK_OF_SECRECY_2: [SECOND_KEY_OF_ARK,ARK_GUARDIAN_ELBEROTH,"That doesn't belong to you.  Don't touch it!","30978-02.htm","30978-03.htm",BOOK_OF_SAINT,"claudia","You forgot to visit Claudia Athebalt! ;)"],
HOLY_ARK_OF_SECRECY_3: [THIRD_KEY_OF_ARK,ARK_GUARDIAN_SHADOWFANG, "Get off my sight, you infidels!","30979-02.htm","30979-03.htm",BRANCH_OF_SAINT,"martien","You forgot to visit Martien! ;)"],
}

# npc: letter to take, item to check for, 1st time htm, return htm, COMPLETED part htm, [x,y,z of chest]
ARK_OWNERS={
HARNE: [HANELLINS_FIRST_LETTER, BLOOD_OF_SAINT, '30144-01.htm', '30144-02.htm', '30144-03.htm', [-418,44174,-3568], ["harne","1"]],
CLAUDIA_ATHEBALT: [HANELLINS_SECOND_LETTER, BOOK_OF_SAINT, '31001-01.htm', '31001-02.htm', '31001-03.htm', [181472,7158,-2725], ["claudia","1"]],
MARTIEN: [HANELLINS_THIRD_LETTER, BRANCH_OF_SAINT, '30645-01.htm', '30645-02.htm', '30645-03.htm', [50693,158674,376], ["martien","1"]]
}
    ...
    # Other NPCs follow:
        ...
        if npcId in ARK_OWNERS.keys() :
            ...
            if st.getQuestItemsCount(ARK_OWNERS[npcId][0])==1:
                ...
                st.set(ARK_OWNERS[npcId][6][0],ARK_OWNERS[npcId][6][1])
            ...
            if st.getQuestItemsCount(ARKS[npcId][0])==0:
                if ARKS[npcId][1] != 0 and st.getInt(ARKS[npcId][6])==1:    # spawn the NPC, if appropriate
