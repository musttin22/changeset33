...
public class FakeHelpers
{
	...
	public static FakePlayer createRandomFakePlayer(int level, int classNumber, boolean pvpZoneBot, boolean farmBot, boolean newbieBot)
	{
	...
	public static void giveEquipmentByClass(FakePlayer player, boolean randomEnchant, int minEnchat, int maxEnchant)
	{
		...
		for (final int id : itemIds)
		{
			...
			final L2ItemInstance item = player.getInventory().addItem("Equipment", id, 1, player, null);
