...
public class Valakas extends Quest implements Runnable
{
	...
	// custom
	private L2GrandBossInstance valakas;
	...
	public String onAdvEvent(String event, L2NpcInstance npc, L2PcInstance player)
	{
		...
		else
		{
			if (event.equalsIgnoreCase("lock_entry_and_spawn_valakas"))
			{
				...
				{
					Announcements.getInstance().announceWithServerName("The Grand boss " + valakas.getName() + " spawned in the world.");
				}
			...
			else if (event.equalsIgnoreCase("custom_spawn_valakas"))
			{
				if (valakas == null)
				{
					int loc_x = 213004;
					...
					valakas = (L2GrandBossInstance) addSpawn(VALAKAS, loc_x, loc_y, loc_z, heading, false, 0);
					GrandBossManager.getInstance().addBoss(valakas);
	...
	public String onKill(L2NpcInstance npc, L2PcInstance killer, boolean isPet)
	{
		...
		if (!npc.getSpawn().is_customBossInstance())
		{
			...
			long respawnTime = (Config.VALAKAS_RESP_FIRST * 3600000);
			int randomTime = (Config.VALAKAS_RESP_SECOND * 3600000);
	...
	public static Valakas getInstance()
	{
	...
	{
		protected static final Valakas INSTANCE = new Valakas(-1, "valakas", "ai");
	}
