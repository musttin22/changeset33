...
public class CommunityBoardManager
{
	...
	public void onBypassCommand(L2GameClient client, String command)
	{
		...
		// {
		// player.sendMessage("Community wasn't loaded yet, try again in few seconds.");
		// player.sendPacket(new ExShowScreenMessage("Community wasn't loaded yet, try again in few seconds.", 2000, 2, false));
		// return;
		// }
	...
	public void handleWriteCommands(L2GameClient client, String url, String arg1, String arg2, String arg3, String arg4, String arg5)
	{
		...
		{
			if (!player.isInsideZone(ZoneId.ZONE_PEACE) && player.getPremiumService() == 0 && player.getLevel() >= 40)
			{
				String msg = "You can't use CB outside town. You need to activate the function \"CB outside town\".";
