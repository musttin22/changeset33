...
public class ItemMarketTable
{
	...
	public void load()
	{
		...
		{
			LOG.error("Error while loading market items " + e.getMessage());
		}
		finally
		{
			CloseUtil.close(con);
	...
	private static class SaveTask implements Runnable
	{
		...
		public void run()
		{
			...
			{
				LOG.error("Error while saving market item into DB " + e.getMessage());
			}
			finally
			{
				CloseUtil.close(con);
	...
	private static class DeleteTask implements Runnable
	{
		...
		public void run()
		{
			...
			{
				LOG.error("Error while deleting market item from DB " + e.getMessage());
			}
			finally
			{
				CloseUtil.close(con);
	...
	private static class UpdateTask implements Runnable
	{
		...
		public void run()
		{
			...
			{
				LOG.error("Error while updating market item in DB " + e.getMessage());
			}
			finally
			{
				CloseUtil.close(con);
