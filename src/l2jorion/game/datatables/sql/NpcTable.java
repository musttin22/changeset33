		...
		try
		{
			...
			try
			{
				...
				while (dropData.next())
				{
					...
					// For Manor new system
					if (dropData.getInt("itemId") == 57)
					{
						npcDat.setMinAdenaDropCount(dropData.getInt("min"));
					}
					
					// SS Blue
					if (dropData.getInt("itemId") == 6360)
					{
						npcDat.setMinSsBlueDropCount(dropData.getInt("min"));
					}
					
					// SS Green
					if (dropData.getInt("itemId") == 6361)
					{
						npcDat.setMinSsGreenDropCount(dropData.getInt("min"));
					}
					
					// SS Red
					if (dropData.getInt("itemId") == 6362)
					{
						npcDat.setMinSsRedDropCount(dropData.getInt("min"));
					}
