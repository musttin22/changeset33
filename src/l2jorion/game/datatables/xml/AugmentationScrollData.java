...
public class AugmentationScrollData implements IXmlReader
{
	...
	public L2AugmentScroll getScrollById(int itemId)
	{
		return _scrolls.get(itemId);
	}
	
	public Map<Integer, L2AugmentScroll> getScrolls()
	{
		return _scrolls;
	}
	...
	public class L2AugmentScroll
	{
		...
		private final int _priceAmount;
		...
		public L2AugmentScroll(StatsSet set)
		{
			...
			_priceItemId = set.getInteger("priceItemId", 0);
			_priceAmount = set.getInteger("priceAmount", 0);
		}
