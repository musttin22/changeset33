...
public class DressMeData implements IXmlReader
{
			...
			if ("list".equalsIgnoreCase(list.getNodeName()))
			{
				for (Node skin = list.getFirstChild(); skin != null; skin = skin.getNextSibling())
				{
					if ("skin".equalsIgnoreCase(skin.getNodeName()))
					{
						...
						int packItemId = parseInteger(attrs, "packItemId");
						int packPrice = parseInteger(attrs, "packPrice");
						
						set.set("packItemId", packItemId);
						set.set("packPrice", packPrice);
						...
						for (Node typeN = skin.getFirstChild(); typeN != null; typeN = typeN.getNextSibling())
						{
							if ("type".equalsIgnoreCase(typeN.getNodeName()))
							{
								...
								int expire = parseInteger(attrs2, "expire", 0);
	...
	public Map<Integer, SkinPackage> getAllArmorSkins()
	{
		return _armorSkins;
	}
	...
	public Map<Integer, SkinPackage> getAllWeaponSkins()
	{
		return _weaponSkins;
	}
	...
	public Map<Integer, SkinPackage> getAllHairSkins()
	{
		return _hairSkins;
	}
	...
	public Map<Integer, SkinPackage> getAllFaceSkins()
	{
		return _faceSkins;
	}
	...
	public Map<Integer, SkinPackage> getAllShieldSkins()
	{
		return _shieldSkins;
	}
