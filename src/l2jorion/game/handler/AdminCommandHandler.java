...
import l2jorion.game.handler.admin.AdminBotReport;
...
{
	private static Logger LOG = LoggerFactory.getLogger(AdminCommandHandler.class);
	...
	private AdminCommandHandler()
	{
		...
		{
			registerAdminCommandHandler(new AdminBotReport());
		}
