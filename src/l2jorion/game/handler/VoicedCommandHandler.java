...
import l2jorion.game.handler.voice.Event_MiniRbAndHighRates;
import l2jorion.game.handler.voice.Event_TVT;
import l2jorion.game.handler.voice.ExpireItems;
import l2jorion.game.handler.voice.Info;
...
import l2jorion.game.handler.voice.botReport;
...
public class VoicedCommandHandler
{
	...
	private VoicedCommandHandler()
	{
		...
		{
			registerVoicedCommandHandler(new Event_MiniRbAndHighRates());
		}
		...
		registerVoicedCommandHandler(new InertiaVoicedCommandHandler());
