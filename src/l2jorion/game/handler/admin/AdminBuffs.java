...
public class AdminBuffs implements IAdminCommandHandler
{
	...
	public void showBuffs(L2Character target, L2PcInstance activeChar)
	{
		...
		for (L2Effect e : effects)
		{
			if (e != null)
			{
				html.append("<tr><td>" + e.getSkill().getName() + "</td><td><button value=\"Remove\" action=\"bypass -h admin_stopbuff " + target.getObjectId() + " " + String.valueOf(e.getSkill().getId())
					+ "\" width=65 height=19 back=\"L2UI_ch3.smallbutton2_over\" fore=\"L2UI_ch3.smallbutton2\"></td></tr>");
			}
		}
		
		html.append("</table><br>");
		html.append("<button value=\"Remove All\" action=\"bypass -h admin_stopallbuffs " + target.getObjectId() + "\" width=65 height=19 back=\"L2UI_ch3.smallbutton2_over\" fore=\"L2UI_ch3.smallbutton2\">");
		html.append("</html>");
