...
public class AdminCreateItem implements IAdminCommandHandler
{
	...
	private void createItem(L2PcInstance activeChar, int id, int num)
	{
		...
		{
			activeChar.sendMessage("You have spawned: " + L2Item.getItemNameById(id) + " (" + id + ") " + num + " in your inventory.");
		}
		else
		{
			activeChar.sendMessage("You have spawned: " + L2Item.getItemNameById(id) + " (" + id + ") " + num + " in " + Player.getName() + " inventory.");
			Player.sendMessage("Admin has spawned: " + L2Item.getItemNameById(id) + "  " + num + " in your inventory.");
		}
		AdminHelpPage.showHelpPage(activeChar, "itemcreation.htm");
	}
