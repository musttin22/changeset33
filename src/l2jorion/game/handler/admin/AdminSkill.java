...
public class AdminSkill implements IAdminCommandHandler
{
	...
	private void removeSkillsPage(final L2PcInstance activeChar, int page)
	{
		...
		replyMSG.append("<td width=40><button value=\"Main\" action=\"bypass -h admin_admin\" width=65 height=19 back=\"L2UI_ch3.smallbutton2_over\" fore=\"L2UI_ch3.smallbutton2\"></td>");
		replyMSG.append("<td width=180><center>Character Selection Menu</center></td>");
		replyMSG.append("<td width=40><button value=\"Back\" action=\"bypass -h admin_show_skills\" width=65 height=19 back=\"L2UI_ch3.smallbutton2_over\" fore=\"L2UI_ch3.smallbutton2\"></td>");
		replyMSG.append("</tr></table>");
		replyMSG.append("<center>Editing <font color=\"LEVEL\">" + player.getName() + "</font> Lv: " + player.getLevel() + " " + player.getTemplate().className + "</center>");
		replyMSG.append("<br1><table width=270><tr><td>Note: Dont forget that modifying player skills can</td></tr>");
		...
		for (int x = 0; x < MaxPages; x++)
		{
			...
			pages += "<td><a action=\"bypass -h admin_remove_skills " + x + "\">[ " + pagenr + " ]</a></td>";
		}
		...
		replyMSG.append("<tr><td width=20>ID:</td>");
		replyMSG.append("<td><edit var=\"id_to_remove\" width=60 height=14></td>");
		replyMSG.append("<td><button value=\"Remove skill\" action=\"bypass -h admin_remove_skill $id_to_remove\" width=65 height=19 back=\"L2UI_ch3.smallbutton2_over\" fore=\"L2UI_ch3.smallbutton2\"></td></tr></table></center>");
