...
public class CustomExpireBuffSlotsItem implements IItemHandler
{
	protected static final Logger LOG = LoggerFactory.getLogger(CustomExpireBuffSlotsItem.class);
