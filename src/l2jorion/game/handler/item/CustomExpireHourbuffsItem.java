...
public class CustomExpireHourbuffsItem implements IItemHandler
{
	protected static final Logger LOG = LoggerFactory.getLogger(CustomExpireHourbuffsItem.class);
