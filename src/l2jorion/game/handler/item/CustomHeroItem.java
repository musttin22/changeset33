...
public class CustomHeroItem implements IItemHandler
{
	
	public CustomHeroItem()
	{
		// null
	}
	
	protected static final Logger LOG = LoggerFactory.getLogger(CustomHeroItem.class);
