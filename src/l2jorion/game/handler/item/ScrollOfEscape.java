...
public class ScrollOfEscape implements IItemHandler
{
	...
	public void useItem(final L2PlayableInstance playable, final L2ItemInstance item)
	{
		...
		if (!Config.ALLOW_SOE_IN_PVP && activeChar.getPvpFlag() != 0 && (item.getItemId() != 736 || item.getItemId() != 1829 || item.getItemId() != 1830))
		{
			activeChar.sendMessage("You can't use blessed scrolls in PvP.");
			return;
		}
	...
	{
		return actor.isCastingNow() || actor.isStunned() || actor.isSleeping() || actor.isParalyzed() || actor.isFakeDeath() || actor.isTeleporting() || actor.isMuted() || actor.isAlikeDead() || actor.isAllSkillsDisabled();
	}
