...
public class BalanceLife implements ISkillHandler
{
	...
	public void useSkill(final L2Character activeChar, final L2Skill skill, final L2Object[] targets)
	{
		...
		for (final L2Object target2 : targets)
		{
			...
			if (Config.PROHIBIT_HEALER_CLASS && player != null && (player.getClassId() == ClassId.cardinal || player.getClassId() == ClassId.bishop || player.getClassId() == ClassId.evaSaint || player.getClassId() == ClassId.shillienSaint) && target.isInsideZone(ZoneId.ZONE_RANDOM))
			{
				continue;
			}
