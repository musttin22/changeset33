...
public class Sow implements ISkillHandler
{
	...
	private boolean calcSuccess()
	{
		...
		final int minlevelSeed = L2Manor.getInstance().getSeedMinLevel(_seedId);
		final int maxlevelSeed = L2Manor.getInstance().getSeedMaxLevel(_seedId);
		...
		{
			_activeChar.sendMessage("Harvest chance: " + basicSuccess + "%");
		}
