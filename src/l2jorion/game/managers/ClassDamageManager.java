...
public class ClassDamageManager
{
	...
	/**
	 * return the product between the attackerMultiplier and attackedMultiplier configured into the classDamages.ini
	 * @param attacker
	 * @param attacked
	...
	public static double getDamageMultiplier(final L2PcInstance attacker, final L2PcInstance attacked)
	{
		...
		{
			Util.printSection("ClassDamageManager");
			LOG.info("Attacker: " + attacker.getName() + " Class: " + getNameById(attacker.getClassId().getId()) + " (ClassId: " + attacker.getClassId().getId() + ") multiplier: " + attackerMulti);
			LOG.info("Attacked: " + attacked.getName() + " Class: " + getNameById(attacked.getClassId().getId()) + " (ClassId: " + attacked.getClassId().getId() + ") multiplier: " + attacked.isMageClass() + " mult: " + attackedMulti);
			LOG.info("Final multiplier: " + output);
		}
