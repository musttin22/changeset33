...
public class DimensionalRiftManager
{
	...
	private void loadRooms()
	{
		...
		{
			LOG.error("Can't load Dimension Rift zones " + e.getMessage(), e);
		}
		finally
		{
			CloseUtil.close(con);
	...
	public void loadSpawns()
	{
		...
		try
		{
			...
			if (!file.exists())
			{
				LOG.warn(getClass().getSimpleName() + ": Couldn't find data/" + file.getName());
				return;
			}
		...
		{
			LOG.error(getClass().getSimpleName() + ": Error on loading dimensional rift spawns: " + e.getMessage(), e);
		}
