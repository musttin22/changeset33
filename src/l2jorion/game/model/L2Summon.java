...
public abstract class L2Summon extends L2PlayableInstance
{
	...
	public L2Summon(final int objectId, final L2NpcTemplate template, final L2PcInstance owner)
	{
		...
		for (L2Skill newSkill : template.getSkills().values())
		{
	...
	{
		// Quick fix: Pet attacked mob and died then mob must attack pet's owner
		if (killer instanceof L2MonsterInstance)
		{
			((L2MonsterInstance) killer).addDamageHate(getOwner(), 100, 1);
		}
	...
	public void updateAndBroadcastStatusAndInfos()
	{
	...
	public void unSummon(final L2PcInstance owner)
	{
		if (!isDead())
		{
			stopAllEffects();
	...
	public void useMagic(L2Skill skill, boolean forceUse, boolean dontMove)
	{
		...
		getOwner().rechargeAutoSoulShot(false, true, true);
	...
	@Override
	public final void reduceCurrentHp(final double value, final L2Character attacker)
	{
		super.reduceCurrentHp(value, attacker, true);
	}
