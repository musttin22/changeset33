...
{
	private static final int BOSS_MAINTENANCE_INTERVAL = 25000;
		...
		if (player != null)
		{
			...
			if (player.getParty() != null)
			{
				...
				for (L2PcInstance member : player.getParty().getPartyMembers())
				{
					if (Config.RON_CUSTOM)
					{
						...
						member.sendMessage("You've got " + points + " raid points.");
					}
			...
			else
			{
				...
				if (Config.RON_CUSTOM)
				{
					...
					player.sendMessage("You've got " + points + " raid points.");
				}
