...
{
	protected static final Logger LOG = Logger.getLogger(L2ItemInstance.class.getName());
	...
	public boolean isAvailable(final L2PcInstance player, final boolean allowAdena, final boolean allowEquipped)
	{
		return (!isEquipped() || allowEquipped) // Not equipped
			...
			// && (getLocation() != ItemLocation.SKIN) // skin
		...
		if (player != null)
		{
			if (Config.L2LIMIT_CUSTOM)
			{
				switch (getItemId())
				{
					case 20005:
					case 20007:
						player.setIncreasmentRatesLow(true);
						break;
					case 20006:
					case 20008:
						player.setIncreasmentRatesHigh(true);
						break;
				}
			}
					...
					else
					{
						...
						if (Config.L2LIMIT_CUSTOM)
						{
							...
							switch (getItemId())
							{
								case 20005:
								case 20007:
									player.setIncreasmentRatesLow(false);
									break;
								case 20006:
								case 20008:
									player.setIncreasmentRatesHigh(false);
									break;
							}
						}
					}
			...
			else
			{
				...
				if (!_consumingMana && (isEquipped() || (Config.L2LIMIT_CUSTOM && (getItemId() == 5964 || getItemId() == 20005 || getItemId() == 20006 || getItemId() == 20007 || getItemId() == 20008))))
				{
	...
	public static L2ItemInstance restoreFromDb(final int objectId)
	{
		...
		try
		{
			...
			if (rs.next())
			{
				...
				else if (inst._mana > 0 && (inst.getLocation() == ItemLocation.PAPERDOLL || (Config.L2LIMIT_CUSTOM && (item_id == 5964 || item_id == 20005 || item_id == 20006 || item_id == 20007 || item_id == 20008))))
				{
					inst //
						.scheduleConsumeManaTask();
				}
	...
	public class ItemDropTask implements Runnable
	{
		...
		public final void run()
		{
			if ((Config.GEODATA) && (_dropper != null))
			{
				...
				{
					LOG.info("Error: something wrong with drop item id -> " + getItemId());
					e.printStackTrace();
				}
			}
