...
{
	protected static final Logger LOG = LoggerFactory.getLogger(SystemMessageId.class);
	 ...
	 */
	public static final SystemMessageId AVOIDED_S1S_ATTACK;
	 ...
	 */
	public static final SystemMessageId S1_WAS_UNAFFECTED_BY_S2;
	 ...
	 */
	public static final SystemMessageId YOU_MUST_SELECT_A_TARGET;
	 ...
	 */
	public static final SystemMessageId S1_PICKED_UP_S2_S3;
	
	/**
	 * ID: 300<br>
	 * Message: $s1 has obtained $s2.
	 */
	public static final SystemMessageId S1_PICKED_UP_S2;
	
	/**
	 * ID: 301<br>
	 * Message: $s2 $s1 has disappeared.
	 */
	public static final SystemMessageId DISSAPEARED_ITEM;
	 ...
	 */
	public static final SystemMessageId ACQUIRED;
	 ...
	 */
	public static final SystemMessageId FRIEND_LIST_HEAD;
	 ...
	 * Message: ========================
	 */
	public static final SystemMessageId FRIEND_LIST_FOOT;
	 ...
	 */
	public static final SystemMessageId S1_SWEEPED_UP_S2_S3;
	 ...
	 */
	public static final SystemMessageId DISSAPEARED_ADENA;
	 ...
	 */
	public static final SystemMessageId MONSRACE_TICKET_SALES_CLOSED;
	
	/**
	 * ID: 820<br>
	 * Message: Monster Race $s2 will begin in $s1 minute(s)!
	 */
	public static final SystemMessageId MONSRACE_BEGINS_IN_S1_MINUTES;
	
	/**
	 * ID: 821<br>
	 * Message: Monster Race $s1 will begin in 30 seconds!
	 */
	public static final SystemMessageId MONSRACE_BEGINS_IN_30_SECONDS;
	
	/**
	 * ID: 822<br>
	 * Message: Monster Race $s1 is about to begin! Countdown in five seconds!
	 */
	public static final SystemMessageId MONSRACE_COUNTDOWN_IN_FIVE_SECONDS;
	 ...
	 */
	public static final SystemMessageId MONSRACE_RACE_END;
	 ...
	 */
	public static final SystemMessageId YOU_HAVE_RECOMMENDED;
	
	/**
	 * ID: 831<br>
	 * Message: You have been recommended by $s1.
	 */
	public static final SystemMessageId YOU_HAVE_BEEN_RECOMMENDED;
	 ...
	 */
	public static final SystemMessageId INVENTORY_VOLUME;
	 ...
	 */
	public static final SystemMessageId CANT_CRAFT_DURING_COMBAT;
	 ...
	 */
	public static final SystemMessageId YOU_NO_LONGER_RECIVE_A_RECOMMENDATION;
	 ...
	 */
	public static final SystemMessageId RESSURECTION_REQUEST;
	 ...
	 */
	public static final SystemMessageId PET_CANNOT_RES;
	 ...
	 */
	public static final SystemMessageId COMMAND_CHANNEL_CONFIRM;
	 ...
	 */
	public static final SystemMessageId YOU_RECEVIED_$51_GLASSES_PC;
	
	/**
	 * ID: 1708<br>
	 * Message: Double points! You acquired $s1 PC Bang Point.
	 */
	public static final SystemMessageId DOUBLE_POINTS_YOU_GOT_$51_GLASSES_PC;
	 ...
	 */
	public static final SystemMessageId S2_CLAN_MEMBER_S1_S_APPRENTICE_HAS_BEEN_REMOVED;
	 ...
	 */
	public static final SystemMessageId CLAN_REPUTATION_SCORE_IS_TOO_LOW;
	 ...
	 */
	public static final SystemMessageId THE_PORTAL_HAS_BEEN_CREATED;
	 ...
	 */
	public static final SystemMessageId LOC_PVP_ZONE_S1_S2_S3;
	 ...
	 */
	public static final SystemMessageId S1S_PARTY_HAS_BEEN_CHALLENGED_TO_A_DUEL;
	 ...
	 */
	public static final SystemMessageId YOU_HAVE_ACCEPTED_S1S_CHALLENGE_TO_A_DUEL_THE_DUEL_WILL_BEGIN_IN_A_FEW_MOMENTS;
	 ...
	 */
	public static final SystemMessageId YOU_HAVE_ACCEPTED_S1S_CHALLENGE_TO_A_PARTY_DUEL_THE_DUEL_WILL_BEGIN_IN_A_FEW_MOMENTS;
	 ...
	 */
	public static final SystemMessageId S1S_PARTY_HAS_CHALLENGED_YOUR_PARTY_TO_A_DUEL;
	 ...
	 */
	public static final SystemMessageId S1S_PARTY_HAS_WON_THE_DUEL;
	 ...
	 */
	public static final SystemMessageId S1_CANNOT_DUEL_BECAUSE_S1S_HP_OR_MP_IS_BELOW_50_PERCENT;
	...
	public static final SystemMessageId YOU_DID_S1_DMG2;
	public static final SystemMessageId S1_GAVE_YOU_S2_DMG22;
	...
	static
	{
		...
		S1_WAS_UNAFFECTED_BY_S2 = new SystemMessageId(139);
		...
		INCORRECT_TARGET = new SystemMessageId(144);
		...
		YOU_MUST_SELECT_A_TARGET = new SystemMessageId(242);
		...
		S1_PICKED_UP_S2_S3 = new SystemMessageId(299);
		S1_PICKED_UP_S2 = new SystemMessageId(300);
		DISSAPEARED_ITEM = new SystemMessageId(301);
		...
		ACQUIRED = new SystemMessageId(371);
		...
		FRIEND_LIST_HEAD = new SystemMessageId(487);
		S1_ONLINE = new SystemMessageId(488);
		S1_OFFLINE = new SystemMessageId(489);
		FRIEND_LIST_FOOT = new SystemMessageId(490);
		...
		S1_SWEEPED_UP_S2_S3 = new SystemMessageId(608);
		...
		DISSAPEARED_ADENA = new SystemMessageId(672);
		...
		MONSRACE_TICKET_SALES_CLOSED = new SystemMessageId(819);
		MONSRACE_BEGINS_IN_S1_MINUTES = new SystemMessageId(820);
		MONSRACE_BEGINS_IN_30_SECONDS = new SystemMessageId(821);
		MONSRACE_COUNTDOWN_IN_FIVE_SECONDS = new SystemMessageId(822);
		MONSRACE_BEGINS_IN_S1_SECONDS = new SystemMessageId(823);
		MONSRACE_RACE_START = new SystemMessageId(824);
		MONSRACE_RACE_END = new SystemMessageId(825);
		...
		YOU_HAVE_RECOMMENDED = new SystemMessageId(830);
		YOU_HAVE_BEEN_RECOMMENDED = new SystemMessageId(831);
		...
		INVENTORY_VOLUME = new SystemMessageId(836);
		...
		CANT_CRAFT_DURING_COMBAT = new SystemMessageId(1135);
		...
		YOU_NO_LONGER_RECIVE_A_RECOMMENDATION = new SystemMessageId(1188);
		...
		RESSURECTION_REQUEST = new SystemMessageId(1510);
		...
		PET_CANNOT_RES = new SystemMessageId(1515);
		...
		COMMAND_CHANNEL_CONFIRM = new SystemMessageId(1529);
		...
		YOU_RECEVIED_$51_GLASSES_PC = new SystemMessageId(1707);
		DOUBLE_POINTS_YOU_GOT_$51_GLASSES_PC = new SystemMessageId(1708);
		...
		S2_CLAN_MEMBER_S1_S_APPRENTICE_HAS_BEEN_REMOVED = new SystemMessageId(1763);
		...
		CLAN_REPUTATION_SCORE_IS_TOO_LOW = new SystemMessageId(1860);
		...
		THE_PORTAL_HAS_BEEN_CREATED = new SystemMessageId(1923);
		LOC_PRIMEVAL_ISLE_S1_S2_S3 = new SystemMessageId(1924);
		LOC_PVP_ZONE_S1_S2_S3 = new SystemMessageId(1925);
		...
		S1S_PARTY_HAS_BEEN_CHALLENGED_TO_A_DUEL = new SystemMessageId(1928);
		S1_HAS_ACCEPTED_YOUR_CHALLENGE_TO_A_DUEL_THE_DUEL_WILL_BEGIN_IN_A_FEW_MOMENTS = new SystemMessageId(1929);
		YOU_HAVE_ACCEPTED_S1S_CHALLENGE_TO_A_DUEL_THE_DUEL_WILL_BEGIN_IN_A_FEW_MOMENTS = new SystemMessageId(1930);
		...
		YOU_HAVE_ACCEPTED_S1S_CHALLENGE_TO_A_PARTY_DUEL_THE_DUEL_WILL_BEGIN_IN_A_FEW_MOMENTS = new SystemMessageId(1933);
		...
		S1S_PARTY_HAS_CHALLENGED_YOUR_PARTY_TO_A_DUEL = new SystemMessageId(1939);
		...
		S1S_PARTY_HAS_WON_THE_DUEL = new SystemMessageId(1951);
		...
		S1_CANNOT_DUEL_BECAUSE_S1S_HP_OR_MP_IS_BELOW_50_PERCENT = new SystemMessageId(2019);
		...
		// Custom
		YOU_DID_S1_DMG2 = new SystemMessageId(2154);
		S1_GAVE_YOU_S2_DMG22 = new SystemMessageId(2155);
