...
public final class AuthLogin extends PacketClient
{
	...
	protected void runImpl()
	{
		...
		/*
		 * if (Config.RON_CUSTOM) { if (client.getAccountName() == null) { if (LoginServerThread.getInstance().addGameServerLogin(_loginName, client)) { client.setAccountName(_loginName); LoginServerThread.getInstance().addWaitingClientAndSendRequest(_loginName, client, key); } } //
		 * LOG.info("test 444444"); return; }
		 */
