...
public final class DlgAnswer extends PacketClient
{
	...
	public void runImpl()
	{
		...
		else if (_messageId == 1326)
		{
			...
			else if (activeChar.dialogRqt != null)
			{
				RequestBypassToServer.deleteMySkin(activeChar, _answer);
			}
			else if (activeChar.dialogRqtBuyAll != null)
			{
				RequestBypassToServer.buyAllSkins(activeChar, _answer);
			}
		}
