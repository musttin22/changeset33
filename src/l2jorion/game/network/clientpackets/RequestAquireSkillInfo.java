...
public class RequestAquireSkillInfo extends PacketClient
{
	...
	protected void runImpl()
	{
		...
		if (_skillType == 0)
		{
			...
			if (Config.ANCIENT_CUSTOM && activeChar.getPremiumService() == 0 && skill.getId() == L2Skill.SKILL_DIVINE_INSPIRATION)
			{
				activeChar.sendMessage("This feature is available for the premium account only.");
				return;
			}
