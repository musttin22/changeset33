...
public class RequestBuySeed extends PacketClient
{
	...
	protected void runImpl()
	{
		...
		for (int i = 0; i < _count; i++)
		{
			...
			{
				double time = (System.currentTimeMillis() - player.getBuySeedsTime());
				double currentTimeInSeconds = (time / 1000);
				String msg = ("Player " + player.getName() + " bought: " + count + " seed(s). It took: " + currentTimeInSeconds + " second(s)");
				GmListTable.broadcastMessageToGMs(msg);
				Log.add(msg, "ManorBuySeeds");
			}
