...
public class Attack extends PacketServer
{
	...
	private class Hit
	{
		...
		Hit(final L2Object target, final int damage, final boolean miss, final boolean crit, final byte shld)
		{
	...
	public void addHit(final L2Object target, final int damage, final boolean miss, final boolean crit, final byte shld)
	{
