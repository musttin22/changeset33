...
public class UserInfo extends PacketServer
{
	...
	protected final void writeImpl()
	{
		...
		else if (_activeChar.isSellingBuff())
		{
			String className = CharTemplateTable.getClassNameById(_activeChar.getClassId().getId());
			title = "SB | " + className + " " + _activeChar.getLevel();
		}
		...
		writeC((_activeChar.isHero() && !_activeChar.isCharacterHideHeroGlow() || (_activeChar.isGM() && Config.GM_HERO_AURA) || _activeChar.getIsPVPHero()) ? 1 : 0); // 0x01: Hero Aura
