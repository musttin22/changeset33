...
public class PowerPackConfig
{
	...
	public static boolean COMMAND_MENU_ENABLED;
	...
	public static String RESPAWN_BOSS_COMMAND;
	public static String RAID_INFO_IDS;
	public static ArrayList<Integer> RAID_INFO_IDS_LIST = new ArrayList<>();
	...
	public static int GMSHOP_SKILL_ENCHNANT_ITEM_ID;
	public static int GMSHOP_SKILL_ENCHNANT_ITEM_COUNT;
	public static byte GMSHOP_SKILL_ENCHNANT_CHANCE;
	public static int GMSHOP_SKILL_ENCHNANT_LIMIT;
	...
	public static void load()
	{
		try
		{
			...
			COMMAND_MENU_ENABLED = Boolean.parseBoolean(p.getProperty("CommandMenuEnabled", "True"));
			...
			RESPAWN_BOSS_COMMAND = p.getProperty("BossCommandTxt", "boss");
			...
			GMSHOP_SKILL_ENCHNANT_ITEM_ID = Integer.parseInt(p.getProperty("GMShopSkillEnchantPriceItemId", "57"));
			GMSHOP_SKILL_ENCHNANT_ITEM_COUNT = Integer.parseInt(p.getProperty("GMShopSkillEnchantPriceItemAmount", "1"));
			GMSHOP_SKILL_ENCHNANT_CHANCE = Byte.parseByte(p.getProperty("GMShopSkillEnchantChance", "100"));
			GMSHOP_SKILL_ENCHNANT_LIMIT = Integer.parseInt(p.getProperty("GMShopSkillEnchantLimit", "3"));
