...
public class TopBoardOfL2RaptorServer implements ICustomByPassHandler
{
	protected static final Logger LOG = LoggerFactory.getLogger(TopBoardOfL2RaptorServer.class);
		...
		if (parameters.startsWith("get"))
		{
			...
			switch (index)
			{
				...
				case 6:
				{
					...
					String text = HtmCache.getInstance().getHtm("data/html/default/13-2.htm");
					html.setHtml(text);
				...
				{
					NpcHtmlMessage html = new NpcHtmlMessage(1);
					String text = HtmCache.getInstance().getHtm("data/html/default/13-1.htm");
					html.setHtml(text);
					player.sendPacket(html);
					break;
				}
