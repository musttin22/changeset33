...
public enum BaseStats
{
	...
	protected static final class STR implements BaseStat
	{
		...
		public final double calcBonus(L2Character actor)
		{
			...
			{
				LOG.error("Character " + actor.getName() + " has STR over max value " + MAX_STAT_VALUE + "... Using " + MAX_STAT_VALUE);
	...
	protected static final class INT implements BaseStat
	{
		...
		public final double calcBonus(L2Character actor)
		{
			...
			{
				LOG.error("Character " + actor.getName() + " has INT over max value " + MAX_STAT_VALUE + "... Using " + MAX_STAT_VALUE);
	...
	protected static final class DEX implements BaseStat
	{
		...
		public final double calcBonus(L2Character actor)
		{
			...
			{
				LOG.error("Character " + actor.getName() + " has DEX over max value " + MAX_STAT_VALUE + "... Using " + MAX_STAT_VALUE);
	...
	protected static final class WIT implements BaseStat
	{
		...
		public final double calcBonus(L2Character actor)
		{
			...
			{
				LOG.error("Character " + actor.getName() + " has WIT over max value " + MAX_STAT_VALUE + "... Using " + MAX_STAT_VALUE);
	...
	protected static final class CON implements BaseStat
	{
		...
		public final double calcBonus(L2Character actor)
		{
			...
			{
				LOG.error("Character " + actor.getName() + " has CON over max value " + MAX_STAT_VALUE + "... Using " + MAX_STAT_VALUE);
	...
	protected static final class MEN implements BaseStat
	{
		...
		public final double calcBonus(L2Character actor)
		{
			...
			{
				LOG.error("Character " + actor.getName() + " has MEN over max value " + MAX_STAT_VALUE + "... Using " + MAX_STAT_VALUE);
	...
	static
	{
		...
		if (file.exists())
		{
			...
			{
				LOG.error("BaseStats: Could not parse file: " + e.getMessage(), e);
			}
