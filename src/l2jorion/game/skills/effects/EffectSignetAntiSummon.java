...
public final class EffectSignetAntiSummon extends L2Effect
{
	...
	public boolean onActionTime()
	{
		...
		final boolean srcInArena = (getEffector().isInsideZone(ZoneId.ZONE_PVP) && !getEffector().isInsideZone(ZoneId.ZONE_SIEGE));
		...
		for (final L2Character cha : _actor.getKnownList().getKnownCharactersInRadius(getSkill().getSkillRadius()))
		{
			...
			{
				if (!L2Skill.checkForAreaOffensiveSkills(getEffector(), cha, getSkill(), srcInArena))
				{
					continue;
				}
