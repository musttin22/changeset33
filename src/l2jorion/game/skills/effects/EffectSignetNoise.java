...
public final class EffectSignetNoise extends L2Effect
{
	...
	public boolean onActionTime()
	{
		...
		final boolean srcInArena = (_actor.isInsideZone(ZoneId.ZONE_PVP) && !_actor.isInsideZone(ZoneId.ZONE_SIEGE));
		...
		for (final L2Character target : _actor.getKnownList().getKnownCharactersInRadius(getSkill().getSkillRadius()))
		{
			...
			if (!L2Skill.checkForAreaOffensiveSkills(_actor, target, getSkill(), srcInArena))
			{
				continue;
			}
