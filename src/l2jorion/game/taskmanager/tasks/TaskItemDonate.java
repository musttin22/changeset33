...
public final class TaskItemDonate implements Runnable
{
	...
	private static void createItem(L2PcInstance target, int itemId, int itemCount, int enchantLevel)
	{
		...
		target.sendMessage("Donation items have been transferred to your character. Thank you, " + target.getName() + "!");
		target.sendPacket(new ExShowScreenMessage("Donation items have been transferred to your character. Thank you, " + target.getName() + "!", 2000, 2, false));
