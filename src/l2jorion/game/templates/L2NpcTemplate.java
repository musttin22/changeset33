...
public final class L2NpcTemplate extends L2CharTemplate
{
	...
	public Race race;
	public int _minAdenaDropCount;
	public int _minSsBlueDropCount;
	public int _minSsGreenDropCount;
	public int _minSsRedDropCount;
	...
	public void addDropData(final L2DropData drop, final int categoryType)
	{
		if (!drop.isQuestDrop())
		{
			...
			if (getType().equalsIgnoreCase("L2RaidBoss"))
			{
				multiplier *= Config.ITEMS_RAID;
			}
			else if (getType().equalsIgnoreCase("L2GrandBoss"))
			{
				multiplier *= Config.ITEMS_BOSS;
			}
			else if (getType().equalsIgnoreCase("L2Minion"))
			{
				multiplier *= Config.ITEMS_MINION;
			}
			else
			{
				multiplier *= Config.RATE_DROP_ITEMS;
			}
			...
			for (final L2DropCategory cat : _categories)
			{
				...
				{
					cat.addDropData(drop, multiplier);
					catExists = true;
					break;
				}
			}
	...
	public void setMinAdenaDropCount(final int count)
	{
		_minAdenaDropCount = count;
	}
	
	public int getMinAdenaDropCount()
	{
		return _minAdenaDropCount;
	}
	
	public void setMinSsBlueDropCount(final int count)
	{
		_minSsBlueDropCount = count;
	}
	
	public int getMinSsBlueDropCount()
	{
		return _minSsBlueDropCount;
	}
	
	public void setMinSsGreenDropCount(final int count)
	{
		_minSsGreenDropCount = count;
	}
	
	public int getMinSsGreenDropCount()
	{
		return _minSsGreenDropCount;
	}
	
	public void setMinSsRedDropCount(final int count)
	{
		_minSsRedDropCount = count;
	}
	
	public int getMinSsRedDropCount()
	{
		return _minSsRedDropCount;
	}
