...
public final class Util
{
	...
	public static String generateBar(int width, int height, long current, long max, String type)
	{
		final StringBuilder sb = new StringBuilder();
		
		current = current > max ? max : current;
		long bar = Math.max((width * (current * 100 / max) / 100), 0);
		sb.append("<table width=" + width + " cellspacing=0 cellpadding=0><tr><td width=" + bar + " align=center><img src=L2UI_CH3.PlayerStatusWnd.ps_" + type + "bar width=" + bar + " height=" + height + "/></td>");
		sb.append("<td width=" + (width - bar) + " align=center><img src=L2UI_CH3.PlayerStatusWnd.ps_" + type + "bar_back width=" + (width - bar) + " height=" + height + "/></td></tr></table>");
