...
public class L2DatabaseFactory
{
	...
	public L2DatabaseFactory()
	{
		...
		{
			LOG.error(getClass().getSimpleName() + ": There has been a problem setting the driver class.", e);
		}
		...
		{
			LOG.error(getClass().getSimpleName() + ": There has been a problem closing the test connection.", e);
		}
	}
	...
	public Connection getConnection()
	{
		...
		while (con == null)
		{
			...
			{
				LOG.error("{}: Unable to get a connection. Trying again...", getClass().getSimpleName(), e);
			}
		}
		return con;
	}
